...
def attack(char_name: str, char_class: str) -> str:
    """Расчет едениц урона при атаке."""
    if char_class == 'warrior':
        return (f'{char_name} '
                f'нанёс урон противнику равный {5 + randint(3, 5)} ед.')
    if char_class == 'mage':
        return (f'{char_name} '
                f'нанёс урон противнику равный {5 + randint(5, 10)} ед.')
    if char_class == 'healer':
        return (f'{char_name} '
                f'нанёс урон противнику равный {5 + randint(-3, -1)} ед.')
    return (f'{char_name} не нанес урон')


def defence(char_name: str, char_class: str) -> str:
    """Расчет едениц блокировки атаки."""
    if char_class == 'warrior':
